...
This table lists the configuration variables required to operate FortiNDRCloud. These variables are specified when configuring a FortiNDR Cloud asset in Splunk SOAR.
